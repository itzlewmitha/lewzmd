                                    ...
                                    switch (commandName) {
                                        case 'menu':
                                            ...
                                            const menuText = `╭━━━〔 ${toBold(" 𝗟𝗘𝗪𝗭 𝗠𝗗 ")} 〕━━━┈⊷\n` +
                                                           ...
                                                           `  ┃ ⋄ ${toBold(".𝗽𝗿𝗶𝘃𝗮𝘁𝗲")}\n` +
                                                           `  ┃ ⋄ ${toBold(".𝗽𝘂𝗯𝗹𝗶𝗰")}\n` +
                                                           `  ┃ ⋄ ${toBold(".𝗮𝘂𝘁𝗼𝗿𝗲_a_d [𝗼𝗻/𝗼𝗳_f]")}\n` +
                                                           `  ┃ ⋄ ${toBold(".𝘀𝘁𝗮_t_u_s [𝗼𝗻/𝗼_f]")}\n` +
                                                           `  ┃ ⋄ ${toBold(".𝗵𝗮𝗰𝗸")}\n` +
                                                           `  ┃ ⋄ ${toBold(".𝗵𝗶𝗱𝗲𝘁𝗮𝗴")}\n` +
                                                           `  ┃ ⋄ ${toBold(".𝘁𝗮𝗴_a_l_l")}\n` +
	                                                       `  ┃ ⋄ ${toBold(".𝘀𝗲𝘁𝗻𝗮𝗺𝗲 (𝗻𝗮𝗺𝗲)")}\n` +
	                                                       ...
	                                                       `  ┃ ⋄ ${toBold(".𝗮𝗻𝘁𝗶𝗰_a_l_l [𝗼𝗻/𝗼𝗳_f]")}\n` +

                                                           `  ┃ ⋄ ${toBold(".𝗴𝗿𝗼𝘂𝗽_i_n_f_o")}\n` +
	                                                       `  ┃ ⋄ ${toBold(".𝗮𝗰𝗰𝗲𝗽𝘁")}\n` +
	                                                       `  ┃ ⋄ ${toBold(".𝗰𝗵𝗶𝗱 (𝗹𝗶𝗻𝗸)")}\n` +
	                                                       `  ┃ ⋄ ${toBold(".𝗳𝗼𝗹𝗹𝗼𝘄 (𝗹𝗶𝗻𝗸)")}\n` +
